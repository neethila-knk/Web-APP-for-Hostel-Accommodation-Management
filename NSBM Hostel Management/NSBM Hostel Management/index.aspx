...
<body>
    <form id="form1" runat="server">
                ...
                <div class="px-3 py-4 my-4 text-center">
                    ...
                    <div class="col-lg-10 mx-auto pt-3">
                        ...
                        <div class="pt-2 d-grid gap-3 d-sm-flex justify-content-sm-center">
                            <button type="button" class="btn btn-primary btn-lg px-4 gap-3">Student</button>
                            <button type="button" class="btn btn-warning btn-lg px-4 gap-3">Landlord</button>
                            <button type="button" class="btn btn-danger btn-lg px-4 gap-3" data-bs-toggle="modal" data-bs-target="#WardenModal">Warden</button>

                            <button type="button" class="btn btn-success btn-lg px-4 gap-3">Web Master</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Warden login Modal -->
        <div class="modal fade" id="WardenModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="WardenModalpLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="WardenModalLabel">Login</h1>
                    ...
                    <div class="modal-body">
                        <form id="loginForm">
                            ...
                            <div>
                                <p>Haven't registered yet? <a href="#" data-bs-toggle="modal" data-bs-target="#WardenModalReg">Register Now</a></p>
                            </div>
                        </form>
                    </div>
        ...
        <!-- Warden register Modal -->
        <div class="modal fade" id="WardenModalReg" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="WardenModalRegLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="WardenModalRegLabel">Login</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="loginForm">
